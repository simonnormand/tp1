...
${OBJECTDIR}/src/CSVReader.o: src/CSVReader.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CSVReader.o src/CSVReader.cpp

${OBJECTDIR}/src/calculs.o: src/calculs.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/calculs.o src/calculs.cpp

${OBJECTDIR}/src/pch.o: src/pch.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/pch.o src/pch.cpp
...
${OBJECTDIR}/test/lib/gtest-1.7.0/codegear/gtest_all.o: test/lib/gtest-1.7.0/codegear/gtest_all.cc 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/test/lib/gtest-1.7.0/codegear/gtest_all.o test/lib/gtest-1.7.0/codegear/gtest_all.cc

${OBJECTDIR}/test/lib/gtest-1.7.0/codegear/gtest_link.o: test/lib/gtest-1.7.0/codegear/gtest_link.cc 
	${MKDIR} -p ${OBJECTDIR}/test/lib/gtest-1.7.0/codegear
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/test/lib/gtest-1.7.0/codegear/gtest_link.o test/lib/gtest-1.7.0/codegear/gtest_link.cc
...
${OBJECTDIR}/test/lib/gtest-1.7.0/samples/sample1.o: test/lib/gtest-1.7.0/samples/sample1.cc 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/test/lib/gtest-1.7.0/samples/sample1.o test/lib/gtest-1.7.0/samples/sample1.cc

${OBJECTDIR}/test/lib/gtest-1.7.0/samples/sample10_unittest.o: test/lib/gtest-1.7.0/samples/sample10_unittest.cc 
	${MKDIR} -p ${OBJECTDIR}/test/lib/gtest-1.7.0/samples
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/test/lib/gtest-1.7.0/samples/sample10_unittest.o test/lib/gtest-1.7.0/samples/sample10_unittest.cc

${OBJECTDIR}/test/lib/gtest-1.7.0/samples/sample1_unittest.o: test/lib/gtest-1.7.0/samples/sample1_unittest.cc 
	${MKDIR} -p ${OBJECTDIR}/test/lib/gtest-1.7.0/samples
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/test/lib/gtest-1.7.0/samples/sample1_unittest.o test/lib/gtest-1.7.0/samples/sample1_unittest.cc

${OBJECTDIR}/test/lib/gtest-1.7.0/samples/sample2.o: test/lib/gtest-1.7.0/samples/sample2.cc 
	${MKDIR} -p ${OBJECTDIR}/test/lib/gtest-1.7.0/samples
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/test/lib/gtest-1.7.0/samples/sample2.o test/lib/gtest-1.7.0/samples/sample2.cc

${OBJECTDIR}/test/lib/gtest-1.7.0/samples/sample2_unittest.o: test/lib/gtest-1.7.0/samples/sample2_unittest.cc 
	${MKDIR} -p ${OBJECTDIR}/test/lib/gtest-1.7.0/samples
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/test/lib/gtest-1.7.0/samples/sample2_unittest.o test/lib/gtest-1.7.0/samples/sample2_unittest.cc

${OBJECTDIR}/test/lib/gtest-1.7.0/samples/sample3_unittest.o: test/lib/gtest-1.7.0/samples/sample3_unittest.cc 
	${MKDIR} -p ${OBJECTDIR}/test/lib/gtest-1.7.0/samples
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/test/lib/gtest-1.7.0/samples/sample3_unittest.o test/lib/gtest-1.7.0/samples/sample3_unittest.cc

${OBJECTDIR}/test/lib/gtest-1.7.0/samples/sample4.o: test/lib/gtest-1.7.0/samples/sample4.cc 
	${MKDIR} -p ${OBJECTDIR}/test/lib/gtest-1.7.0/samples
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/test/lib/gtest-1.7.0/samples/sample4.o test/lib/gtest-1.7.0/samples/sample4.cc

${OBJECTDIR}/test/lib/gtest-1.7.0/samples/sample4_unittest.o: test/lib/gtest-1.7.0/samples/sample4_unittest.cc 
	${MKDIR} -p ${OBJECTDIR}/test/lib/gtest-1.7.0/samples
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/test/lib/gtest-1.7.0/samples/sample4_unittest.o test/lib/gtest-1.7.0/samples/sample4_unittest.cc

${OBJECTDIR}/test/lib/gtest-1.7.0/samples/sample5_unittest.o: test/lib/gtest-1.7.0/samples/sample5_unittest.cc 
	${MKDIR} -p ${OBJECTDIR}/test/lib/gtest-1.7.0/samples
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/test/lib/gtest-1.7.0/samples/sample5_unittest.o test/lib/gtest-1.7.0/samples/sample5_unittest.cc

${OBJECTDIR}/test/lib/gtest-1.7.0/samples/sample6_unittest.o: test/lib/gtest-1.7.0/samples/sample6_unittest.cc 
	${MKDIR} -p ${OBJECTDIR}/test/lib/gtest-1.7.0/samples
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/test/lib/gtest-1.7.0/samples/sample6_unittest.o test/lib/gtest-1.7.0/samples/sample6_unittest.cc

${OBJECTDIR}/test/lib/gtest-1.7.0/samples/sample7_unittest.o: test/lib/gtest-1.7.0/samples/sample7_unittest.cc 
	${MKDIR} -p ${OBJECTDIR}/test/lib/gtest-1.7.0/samples
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/test/lib/gtest-1.7.0/samples/sample7_unittest.o test/lib/gtest-1.7.0/samples/sample7_unittest.cc

${OBJECTDIR}/test/lib/gtest-1.7.0/samples/sample8_unittest.o: test/lib/gtest-1.7.0/samples/sample8_unittest.cc 
	${MKDIR} -p ${OBJECTDIR}/test/lib/gtest-1.7.0/samples
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/test/lib/gtest-1.7.0/samples/sample8_unittest.o test/lib/gtest-1.7.0/samples/sample8_unittest.cc

${OBJECTDIR}/test/lib/gtest-1.7.0/samples/sample9_unittest.o: test/lib/gtest-1.7.0/samples/sample9_unittest.cc 
	${MKDIR} -p ${OBJECTDIR}/test/lib/gtest-1.7.0/samples
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/test/lib/gtest-1.7.0/samples/sample9_unittest.o test/lib/gtest-1.7.0/samples/sample9_unittest.cc
...
${OBJECTDIR}/test/lib/gtest-1.7.0/src/gtest-all.o: test/lib/gtest-1.7.0/src/gtest-all.cc 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/test/lib/gtest-1.7.0/src/gtest-all.o test/lib/gtest-1.7.0/src/gtest-all.cc

${OBJECTDIR}/test/lib/gtest-1.7.0/src/gtest-death-test.o: test/lib/gtest-1.7.0/src/gtest-death-test.cc 
	${MKDIR} -p ${OBJECTDIR}/test/lib/gtest-1.7.0/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/test/lib/gtest-1.7.0/src/gtest-death-test.o test/lib/gtest-1.7.0/src/gtest-death-test.cc

${OBJECTDIR}/test/lib/gtest-1.7.0/src/gtest-filepath.o: test/lib/gtest-1.7.0/src/gtest-filepath.cc 
	${MKDIR} -p ${OBJECTDIR}/test/lib/gtest-1.7.0/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/test/lib/gtest-1.7.0/src/gtest-filepath.o test/lib/gtest-1.7.0/src/gtest-filepath.cc

${OBJECTDIR}/test/lib/gtest-1.7.0/src/gtest-port.o: test/lib/gtest-1.7.0/src/gtest-port.cc 
	${MKDIR} -p ${OBJECTDIR}/test/lib/gtest-1.7.0/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/test/lib/gtest-1.7.0/src/gtest-port.o test/lib/gtest-1.7.0/src/gtest-port.cc

${OBJECTDIR}/test/lib/gtest-1.7.0/src/gtest-printers.o: test/lib/gtest-1.7.0/src/gtest-printers.cc 
	${MKDIR} -p ${OBJECTDIR}/test/lib/gtest-1.7.0/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/test/lib/gtest-1.7.0/src/gtest-printers.o test/lib/gtest-1.7.0/src/gtest-printers.cc

${OBJECTDIR}/test/lib/gtest-1.7.0/src/gtest-test-part.o: test/lib/gtest-1.7.0/src/gtest-test-part.cc 
	${MKDIR} -p ${OBJECTDIR}/test/lib/gtest-1.7.0/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/test/lib/gtest-1.7.0/src/gtest-test-part.o test/lib/gtest-1.7.0/src/gtest-test-part.cc

${OBJECTDIR}/test/lib/gtest-1.7.0/src/gtest-typed-test.o: test/lib/gtest-1.7.0/src/gtest-typed-test.cc 
	${MKDIR} -p ${OBJECTDIR}/test/lib/gtest-1.7.0/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/test/lib/gtest-1.7.0/src/gtest-typed-test.o test/lib/gtest-1.7.0/src/gtest-typed-test.cc

${OBJECTDIR}/test/lib/gtest-1.7.0/src/gtest.o: test/lib/gtest-1.7.0/src/gtest.cc 
	${MKDIR} -p ${OBJECTDIR}/test/lib/gtest-1.7.0/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/test/lib/gtest-1.7.0/src/gtest.o test/lib/gtest-1.7.0/src/gtest.cc

${OBJECTDIR}/test/lib/gtest-1.7.0/src/gtest_main.o: test/lib/gtest-1.7.0/src/gtest_main.cc 
	${MKDIR} -p ${OBJECTDIR}/test/lib/gtest-1.7.0/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/test/lib/gtest-1.7.0/src/gtest_main.o test/lib/gtest-1.7.0/src/gtest_main.cc
...
${OBJECTDIR}/test/lib/gtest-1.7.0/xcode/Samples/FrameworkSample/widget.o: test/lib/gtest-1.7.0/xcode/Samples/FrameworkSample/widget.cc 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/test/lib/gtest-1.7.0/xcode/Samples/FrameworkSample/widget.o test/lib/gtest-1.7.0/xcode/Samples/FrameworkSample/widget.cc
...
${OBJECTDIR}/test/lib/gtest-1.7.0/xcode/Samples/FrameworkSample/widget_test.o: test/lib/gtest-1.7.0/xcode/Samples/FrameworkSample/widget_test.cc 
	${MKDIR} -p ${OBJECTDIR}/test/lib/gtest-1.7.0/xcode/Samples/FrameworkSample
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/test/lib/gtest-1.7.0/xcode/Samples/FrameworkSample/widget_test.o test/lib/gtest-1.7.0/xcode/Samples/FrameworkSample/widget_test.cc

${OBJECTDIR}/test/testEcartType/testEcartType.o: test/testEcartType/testEcartType.cpp 
	${MKDIR} -p ${OBJECTDIR}/test/testEcartType
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/test/testEcartType/testEcartType.o test/testEcartType/testEcartType.cpp

${OBJECTDIR}/test/testMoyenne/testMoyenne.o: test/testMoyenne/testMoyenne.cpp 
	${MKDIR} -p ${OBJECTDIR}/test/testMoyenne
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/test/testMoyenne/testMoyenne.o test/testMoyenne/testMoyenne.cpp

${OBJECTDIR}/test/testVariance/testVariance.o: test/testVariance/testVariance.cpp 
	${MKDIR} -p ${OBJECTDIR}/test/testVariance
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/test/testVariance/testVariance.o test/testVariance/testVariance.cpp
